            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-6 pt-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Faster Reports</p>
                </div>
                <div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-muted/50 p-3 rounded-lg">
                      ...
                      <p className="text-xl font-bold text-green-600">$284,500</p>
                      <p className="text-xs text-green-600">↑ 12% vs last month</p>
                    </div>
                    <div className="bg-muted/50 p-3 rounded-lg">
                      <p className="text-xs text-muted-foreground mb-1">Active Jobs</p>
                      <p className="text-xl font-bold">18</p>
                      <p className="text-xs text-muted-foreground">$1.2M pipeline</p>
                    </div>
                    <div className="bg-muted/50 p-3 rounded-lg">
                    ...
                    <div className="bg-muted/50 p-3 rounded-lg">
                      ...
                      <p className="text-xl font-bold text-orange-600">$45,200</p>
                  ...
                  <div className="pt-4 border-t">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-sm text-muted-foreground">Top Performing Job</span>
                      <span className="text-sm font-medium">45% margin</span>
                    </div>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">
              Powerful Analytics for Smart Decisions
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Get insights that matter with comprehensive analytics designed for construction businesses.
            </p>
          </div>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="p-6 text-center">
              <LineChart className="h-12 w-12 mx-auto mb-4 text-indigo-500" />
              <h3 className="text-lg font-semibold mb-2">Financial Reports</h3>
              <p className="text-sm text-muted-foreground">
                P&L statements, cash flow analysis, and revenue forecasts
              </p>
            </Card>
            ...
            <Card className="p-6 text-center">
              ...
              <p className="text-sm text-muted-foreground">
                Job completion rates, crew utilization, and efficiency scores
              </p>
            </Card>
            ...
            <Card className="p-6 text-center">
              ...
              <p className="text-sm text-muted-foreground">
                Build your own KPIs and track what matters most to you
              </p>
            </Card>
          </div>
        </div>
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-indigo-500/10 to-indigo-600/10">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8">
            Join contractors who increased profits by 35% with better analytics.
