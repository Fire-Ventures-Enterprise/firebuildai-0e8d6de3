...
import { EnhancedEstimate, EnhancedEstimateItem, EstimatePaymentScheduleItem } from "@/types/enhanced-estimate";
...
interface EnhancedEstimateFormProps {
  ...
  onSave: (data: EnhancedEstimate) => void;
  onCancel: () => void;
}
...
export default function EnhancedEstimateForm({ 
  ...
  onSave, 
  onCancel 
}: EnhancedEstimateFormProps) {
  const { user } = useAuth();
  const { toast } = useToast();
  
  // Form state
  const [formData, setFormData] = useState<EnhancedEstimate>({
    estimateNumber: '',
    status: 'draft',
    issueDate: new Date(),
    ...
    notes: '',
    privateNotes: '',
    termsConditions: 'This estimate is valid for 30 days from the issue date.\nAll work will be completed according to applicable building codes.\nPayment terms: Net 30 days.',
    photos: [],
    attachments: []
  });
  ...
  const updateLineItem = (index: number, field: keyof EnhancedEstimateItem, value: any) => {
    setFormData(prev => {
  ...
  const updatePaymentSchedule = (index: number, field: keyof EstimatePaymentScheduleItem, value: any) => {
    setFormData(prev => {
  ...
  }, [formData.items, formData.discount, formData.discountType, formData.depositRequest, formData.depositType, formData.taxRate]);
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="items" className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                <CardTitle>Estimate For</CardTitle>
              </CardHeader>
              <CardContent>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      const expirationDate = new Date(formData.issueDate);
                      expirationDate.setDate(expirationDate.getDate() + days);
                      setFormData(prev => ({ ...prev, validForDays: days, expirationDate }));
                    }}
                  />
                </div>
              </div>
          ...
          <Card>
            ...
            <CardContent>
              <Textarea
                ...
                placeholder="Describe the scope of work to be completed..."
                rows={5}
              />
            </CardContent>
          </Card>
                  ...
                  <div key={index} className="grid grid-cols-6 gap-2 items-end">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => updatePaymentSchedule(index, 'milestone', e.target.value)}
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex items-center justify-between">
                <Label htmlFor="accept-online">Accept Online Payments</Label>
                <Switch
                  id="accept-online"
        ...
        <TabsContent value="contract" className="space-y-6">
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <Label htmlFor="contract-required">Attach Contract</Label>
                  <Switch
