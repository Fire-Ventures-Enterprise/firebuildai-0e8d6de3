...
CREATE POLICY "Users can view team members they added" ON public.team_members
  FOR SELECT USING (auth.uid() = added_by);

CREATE POLICY "Users can manage team members they added" ON public.team_members
...
-- Create triggers for updated_at on team_members and schedules
