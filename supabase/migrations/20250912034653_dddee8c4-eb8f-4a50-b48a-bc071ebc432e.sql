...
-- Create template tasks for a sample template (Kitchen Remodel)
INSERT INTO template_tasks (template_id, task_code, name, description, phase, estimated_hours, dependencies, trade, sort_order)
SELECT 
  t.id,
  'DEMO-001',
  'Kitchen Demolition',
...
SELECT 
  ...
  'ELEC-001',
  'Electrical Rough-In',
  'Install new circuits, outlets, and lighting boxes',
  'rough_in',
  12,
  '["DEMO-001"]'::jsonb,
  'electrical',
...
SELECT 
  ...
  'PLUMB-001',
  'Plumbing Rough-In',
  'Install supply lines and drains for sink and appliances',
  'rough_in',
  8,
  '["DEMO-001"]'::jsonb,
  'plumbing',
